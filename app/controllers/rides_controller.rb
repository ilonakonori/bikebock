class RidesController < ApplicationController
  ...
  def ride_params
    params.require(:ride).permit(:title, :short_description, :start_location, :start_time, :end_location, :end_time, :difficulty, :number_of_people, :available_dates, :user_id, :photo_1, :photo_2, :photo_3, photos: [])
  end
